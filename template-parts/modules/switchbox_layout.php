    ...
    <section class="switchbox">
        <div class="container">
            <?php while(have_rows('box_group') ) : the_row(); 
                ...
                <div class="row <?php echo $flipColumns; ?> switchbox__container">
                    <?php if($image) : ?>
                        <div class="switchbox__image col-lg-<?php echo $col; ?> order-1 order-lg-2 aos-init aos-animate" data-aos="fade-left">
                            <img src="<?php echo $image; ?>" class="img-fluid" alt="">
                        </div>
                    <?php endif; ?>
                    <div class="switchbox__content col-lg-<?php echo $col; ?>  pt-4 pt-lg-0 order-2 order-lg-1 content aos-init aos-animate" data-aos="fade-right">
